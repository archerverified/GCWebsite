...
export function ServiceAreasSection() {
  ...
  return (
    <section className="w-full bg-gc-ink border-t-[4px] border-b-[4px] border-gc-yellow py-12 lg:py-16 font-product-sans px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 2xl:px-24" data-font-probe="service-areas">
      <div className="container mx-auto max-w-6xl lg:px-16 px-8 py-[27px] my-[0px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 max-w-5xl mx-auto">
          {/* Left Column */}
          <div className="flex flex-col gap-4 lg:gap-6 p-[0px] m-[0px]">
            {leftColumnCities.map((city, index) => (
              <div key={index} className="flex items-center gap-4">
                <svg className="w-5 h-7 flex-shrink-0 fill-gc-yellow" viewBox="0 0 16.3854 27" style={{ transform: 'scaleX(-1)' }}>
