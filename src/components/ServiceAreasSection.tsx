...
export function ServiceAreasSection() {
  ...
  return (
    <section className="w-full bg-[#323232] border-t-[4px] border-b-[4px] border-[#f7bd15] py-12 lg:py-16 font-product-sans px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px]" data-font-probe="service-areas">
