...
export function Texas() {
  ...
  return (
    <main className="bg-white">
      ...
      <section className="py-16 lg:py-24 px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px] bg-[#35363a]">
      ...
      {/* Cities Grid Hub */}
      <section id="cities" className="py-16 lg:py-24 px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px]">
