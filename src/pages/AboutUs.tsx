...
export function AboutUs() {
  ...
  return (
    <main className="bg-white">
      {/* Hero Section */}
      <section className="py-16 lg:py-24 px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px] bg-[#35363a]/90 rounded-b-[20px] border-t-2 border-t-[#fec300] border-x-0 border-b-0">
