      ...
      <section className="py-12 lg:py-16 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 2xl:px-24">
        <div className="container mx-auto max-w-4xl prose prose-lg">
          <p className="font-product-sans text-gc-gray-600 mb-6">
            This Privacy Policy is provided by AAA Organization LLC, doing business as ("DBA") Garage
            Cowboy. "Garage Cowboy" is the trade name (DBA) of AAA Organization LLC; both names refer
            to the same company. References to "Garage Cowboy," "we," "us," and "our" in this policy
            mean AAA Organization LLC DBA Garage Cowboy.
          </p>
          ...
          <p className="font-product-sans text-gc-gray-600 mb-6">
            When you opt in to receive SMS text messages from AAA Organization LLC (DBA Garage Cowboy), we collect your mobile
