...
export function CityDetail() {
  ...
  return (
    <main className="bg-white">
      ...
      {/* Main Content - Intro */}
      <section className="py-16 lg:py-24 px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px]">
      ...
      {content.sections && content.sections.length > 0 && (
        <section className="py-16 lg:py-24 px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px] bg-[#f5f5f5]">
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-24 px-[48px] md:px-[96px] lg:px-[192px] xl:px-[288px] bg-[#fec300]">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="font-product-sans font-black text-3xl md:text-4xl text-[#222] mb-4">
            Need Garage Door Service in {cityName}?
          </h2>
          <p className="font-product-sans text-xl text-[#222] mb-8 opacity-80">
            Our expert technicians are ready to help with any garage door repair or installation
          </p>
          <a
            href="tel:8712560122"
